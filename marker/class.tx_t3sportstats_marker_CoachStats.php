...
class tx_t3sportstats_marker_CoachStats extends tx_rnbase_util_BaseMarker
{
    ...
    public function parseTemplate($template, $item, &$formatter, $confId, $marker = 'MATCH')
    {
        ...
        tx_rnbase_util_Misc::callHook('t3sportstats', 'coachStatsMarker_initRecord', array(
            'item' => &$item,
            'template' => &$template,
            'confid' => $confId,
            'marker' => $marker,
        ...
        tx_rnbase_util_Misc::callHook('t3sportstats', 'coachStatsMarker_afterSubst', array(
            'item' => &$item,
            'template' => &$template,
            'confid' => $confId,
            'marker' => $marker,
